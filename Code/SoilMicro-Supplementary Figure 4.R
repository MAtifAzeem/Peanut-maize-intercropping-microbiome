...
wdImport<-("E:/Study/SCI/Soil Micro/SCI/Figures/16S/QIIME2-DAD2/FourStages-DAD2-F295+R205-Filtered1/Lefse/Maize")
wdOutput <- ("E:/Study/SCI/Soil Micro/SCI/Figures/16S/QIIME2-DAD2/FourStages-DAD2-F295+R205-Filtered1/Lefse/Maize")

#### 3. Fig. 3a-LefSe_MMvsIM_results####
### 3.1 Import and process data ###
setwd(wdImport)
LefSe_MMvsIM <- read_excel("Lefse_FourStages_Filtered1_IMvsMM_LDA3.0_p0.05_significant.xlsx",
                                    sheet = "Sheet1")
...
setwd(wdImport)
getwd()
genus_biomarker <- read_excel("Lefse_FourStages_Filtered1_IMvsMM_LDA3.0_p0.05_significant.xlsx",
                              sheet = "Sheet2")
