...
ggsave(paste("SIP_reduction_Bar",".pdf",sep=""),
       SIP_reduction_Bar,device=cairo_pdf,width=50,height=72,dpi = 300,units = "mm")
...
ggsave(paste("NIP_reduction_Bar",".pdf",sep=""),
       NIP_reduction_Bar,device=cairo_pdf,width=50,height=72,dpi = 300,units = "mm")
...
ggsave(paste("SMP_reduction_Bar",".pdf",sep=""),
       SMP_reduction_Bar,device=cairo_pdf,width=50,height=72,dpi = 300,units = "mm")
...
ggsave(paste("NMP_reduction_Bar",".pdf",sep=""),
       NMP_reduction_Bar,device=cairo_pdf,width=50,height=72,dpi = 300,units = "mm")
...
ggsave(paste("SIM_MArelease_Bar",".pdf",sep=""),
       SIM_MArelease_Bar,device=cairo_pdf,width=50,height=52,dpi = 300,units = "mm")
...
ggsave(paste("NIM_MArelease_Bar",".pdf",sep=""),
       NIM_MArelease_Bar,device=cairo_pdf,width=50,height=52,dpi = 300,units = "mm")
